    ...
    */
    ...
    {   
        ...
        return datatables()
                ...
                ->editColumn('content', function ($about) {
                    return $about->content ?? '-';
                })
                ->editColumn('created_at', function ($about) {
                    return  $about->getCreatedAt();
                })
                ->addColumn('image', function ($about) {
                    return view('admin.pages.abouts.datatable.image' , ['about' => $about]);
                })
                ->addColumn('actions', function ($about) {
                    return view('admin.pages.abouts.datatable.action' , ['about' => $about]);
                })
                ->rawColumns(['actions', 'title','content','created_at','image']);
    }
    ...
    {
        return About::filter(request()->all());
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            [
                'name'  => 'content',
                'data'  => 'content',
                'title' => TranslationHelper::translate('content' , 'admin') 
            ],
            [
                'name'  => 'image',
                'data'  => 'image',
    ...
    private function getDataArrayArabic(){
        if(app()->getLocale()  == 'ar'){
            return    [
                    ...
                    'sLengthMenu'   => 'اعرض _MENU_ نبذات',
                    'sZeroRecords'  => 'لم يعثر على أية نبذات',
                    'sInfo'         => 'عرض _START_ إلى _END_ من أصل _TOTAL_ نبذات',
                    'sInfoEmpty'    => 'يعرض 0 إلى 0 من أصل 0 نبذة',
