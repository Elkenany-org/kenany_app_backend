...
class BannersDataTable extends DataTable
{
    ...
    */
    ...
    {   
        ...
        return datatables()
                ...
                ->editColumn('title', function ($silder) {
                    return $silder->title ?? '-';
                })
                ->editColumn('created_at', function ($silder) {
                    return  $silder->getCreatedAt();
                })
                ->addColumn('image', function ($silder) {
                    return view('admin.pages.sliders.datatable.image' , ['slider' => $silder]);
                })
                ->addColumn('actions', function ($silder) {
                    return view('admin.pages.sliders.datatable.action' , ['slider' => $silder]);
                })
    ...
    */
    ...
    {
        return Slider::filter(request()->all());
    }
    ...
    private function getDataArrayArabic(){
        if(app()->getLocale()  == 'ar'){
            return    [
                    ...
                    'sLengthMenu'   => 'اعرض _MENU_ اعلانات',
                    'sZeroRecords'  => 'لم يعثر على أية اعلانات',
                    'sInfo'         => 'عرض _START_ إلى _END_ من أصل _TOTAL_ اعلانات',
                    'sInfoEmpty'    => 'يعرض 0 إلى 0 من أصل 0 اعلان',
