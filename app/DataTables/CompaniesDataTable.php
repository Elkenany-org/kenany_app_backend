...
class CompaniesDataTable extends DataTable
{
    ...
    */
    ...
    {   
        ...
        return datatables()
                ...
                ->editColumn('short_desc', function ($company) {
                    return $company->short_desc;
                })
                ->editColumn('created_at', function ($company) {
                    return  $company->getCreatedAt();
                })
                ->addColumn('actions', function ($company) {
                    return view('admin.pages.companies.datatable.action' , ['company' => $company]);
                })
    ...
    */
    ...
    {        
        return Company::filter(request()->all());
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            [
                'name'  => 'short',
                'data'  => 'short_desc',
                'title' => TranslationHelper::translate('short_desc' , 'admin') 
            ],
            [
                'name'  => 'created_at',
                'data'  => 'created_at',
    ...
    private function getDataArrayArabic(){
        if(app()->getLocale()  == 'ar'){
            return    [
                    ...
                    'sLengthMenu'   => 'اعرض _MENU_ شركات',
                    'sZeroRecords'  => 'لم يعثر على أية شركات',
                    'sInfo'         => 'عرض _START_ إلى _END_ من أصل _TOTAL_ شركات',
