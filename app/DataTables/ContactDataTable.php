    ...
    {   
        ...
        return datatables()
                ...
                ->addColumn('actions', function ($contact) {
                    return view('admin.pages.contact.datatable.action' , ['contact' => $contact]);
                })
                ->rawColumns(['actions','name','created_at','email','phone']);
    }
    ...
    public function getColumns(): array
    {
         return [
            ...
            [
                'name'  => 'phone',
                'data'  => 'phone',
                'title' => TranslationHelper::translate('phone' , 'admin')
            ],
            [
                'name'  => 'created_at',
                'data'  => 'created_at',
    ...
    private function getDataArrayArabic(){
        if(app()->getLocale()  == 'ar'){
            return    [
                    ...
                    'sLengthMenu'   => 'اعرض _MENU_ الرسائل',
                    'sZeroRecords'  => 'لم يعثر على أية الرسائل',
                    'sInfo'         => 'عرض _START_ إلى _END_ من أصل _TOTAL_ الرسائل',
