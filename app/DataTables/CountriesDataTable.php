...
class CountriesDataTable extends DataTable
{
    ...
    {   
        ...
        return datatables()
                ...
                ->addColumn('actions', function ($country) {
                    return view('admin.pages.countries.datatable.action' , ['country' => $country]);
                })
    ...
    */
    ...
    {        
        return Country::filter(request()->all());
    }
    ...
    private function getDataArrayArabic()
    {
        if(app()->getLocale()  == 'ar'){
            return    [
                    ...
                    'sLengthMenu'   => 'اعرض _MENU_ دول',
                    'sZeroRecords'  => 'لم يعثر على أية دول',
                    'sInfo'         => 'عرض _START_ إلى _END_ من أصل _TOTAL_ دول',
