    ...
    {   
        ...
        return datatables()
                ...
                ->editColumn('created_at', function ($faq) {
                    return  $faq->getCreatedAt();
                })
                ->addColumn('actions', function ($faq) {
                    return view('admin.pages.faqs.datatable.action' , ['faq' => $faq]);
                })
                ->rawColumns(['actions','question','answer','created_at']);
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            [
                'name'  => 'question',
                'data'  => 'question',
                'title' => TranslationHelper::translate('question' , 'admin')
            ],
            [
                'name'  => 'answer',
                'data'  => 'answer',
                'title' => TranslationHelper::translate('answer' , 'admin')
            ],
            [
                'name'  => 'created_at',
                'data'  => 'created_at',
    ...
    private function getDataArrayArabic(){
        if(app()->getLocale()  == 'ar'){
            return    [
                    ...
                    'sLengthMenu'   => 'اعرض _MENU_ الاسئلة',
                    'sZeroRecords'  => 'لم يعثر على أية الاسئلة',
                    'sInfo'         => 'عرض _START_ إلى _END_ من أصل _TOTAL_ الاسئلة',
                    'sInfoEmpty'    => 'يعرض 0 إلى 0 من أصل 0 سوال',
