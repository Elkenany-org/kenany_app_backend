    ...
    */
    ...
    {   
        ...
        return datatables()
                ...
                ->editColumn('period', function ($package) {
                ...
                ->addColumn('actions', function ($package) {
                    return view('admin.pages.packages.datatable.action' , ['package' => $package]);
                })
                ->rawColumns([ 'actions', 'name' , 'period' , 'price' ,'created_at' ]);
    }
    ...
    {
        return Package::filter(request()->all());
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            [
                'name'  => 'period',
                'data'  => 'period',
                'title' => TranslationHelper::translate('period' , 'admin') 
            ],
            [
                'name'  => 'price',
                'data'  => 'price',
    ...
    private function getDataArrayArabic(){
        if(app()->getLocale()  == 'ar'){
            return    [
                    ...
                    'sLengthMenu'   => 'اعرض _MENU_ باقة',
                    'sZeroRecords'  => 'لم يعثر على أية باقة',
                    'sInfo'         => 'عرض _START_ إلى _END_ من أصل _TOTAL_ باقة',
                    'sInfoEmpty'    => 'يعرض 0 إلى 0 من أصل 0 باقة',
