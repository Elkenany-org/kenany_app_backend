...
class PortsDataTable extends DataTable
{
    ...
    */
    ...
    {   
        ...
        return datatables()
                ...
                ->editColumn('created_at', function ($port) {
                    return  $port->getCreatedAt();
                })
                ->addColumn('actions', function ($port) {
                    return view('admin.pages.ports.datatable.action' , ['port' => $port]);
                })
    ...
    */
    ...
    {        
        return Port::filter(request()->all());
    }
    ...
    private function getDataArrayArabic(){
        if(app()->getLocale()  == 'ar'){
            return    [
                    ...
                    'sLengthMenu'   => 'اعرض _MENU_ موانئ',
                    'sZeroRecords'  => 'لم يعثر على أية موانئ',
                    'sInfo'         => 'عرض _START_ إلى _END_ من أصل _TOTAL_ موانئ',
