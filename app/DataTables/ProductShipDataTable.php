...
class ProductShipDataTable extends DataTable
{
    ...
    {   
        ...
        return datatables()
                ...
                ->addColumn('actions', function ($product) {
                    return view('admin.pages.ship_products.datatable.action' , ['product' => $product]);
                })
    ...
    */
    ...
    {        
        return ShipsProduct::filter(request()->all());
    }
    ...
    private function getDataArrayArabic(){
        if(app()->getLocale()  == 'ar'){
            return    [
                    ...
                    'sLengthMenu'   => 'اعرض _MENU_ منتجات',
                    'sZeroRecords'  => 'لم يعثر على أية منتجات',
                    'sInfo'         => 'عرض _START_ إلى _END_ من أصل _TOTAL_ منتجات',
