...
class RolesDataTable extends DataTable
{
    ...
    */
    ...
    {   
        ...
        return datatables()
                ...
                ->addColumn('actions', function ($role) {
                    return view('admin.pages.roles.datatable.action' , ['role' => $role]);
                })
                ->rawColumns(['actions', 'name' , 'created_at']);
    }
    ...
    {
        return Role::filter(request()->all())->where('name' , '!=' , 'admin_country');
    }
    ...
    private function getDataArrayArabic(){
        if(app()->getLocale()  == 'ar'){
            return    [
                    ...
                    'sLengthMenu'   => 'اعرض _MENU_ ادوار',
                    'sZeroRecords'  => 'لم يعثر على أية ادوار',
                    'sInfo'         => 'عرض _START_ إلى _END_ من أصل _TOTAL_ ادوار',
                    'sInfoEmpty'    => 'يعرض 0 إلى 0 من أصل 0 دور',
