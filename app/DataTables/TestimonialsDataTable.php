...
class TestimonialsDataTable extends DataTable
{
    ...
    */
    ...
    {   
        ...
        return datatables()
                ...
                ->editColumn('created_at', function ($testimonial) {
                    return  $testimonial->getCreatedAt();
                })
                ->addColumn('actions', function ($testimonial) {
                    return view('admin.pages.testimonials.datatable.action' , ['testimonial' => $testimonial]);
                })
                ->rawColumns(['actions', 'name','content','created_at']);
    }
    ...
    {
        return Testimonial::filter(request()->all());
    }
    ...
    private function getDataArrayArabic(){
        if(app()->getLocale()  == 'ar'){
            return    [
                    ...
                    'sLengthMenu'   => 'اعرض _MENU_ اراء العملاء',
                    'sZeroRecords'  => 'لم يعثر على أية اراء العملاء',
                    'sInfo'         => 'عرض _START_ إلى _END_ من أصل _TOTAL_ اراء العملاء',
                    'sInfoEmpty'    => 'يعرض 0 إلى 0 من أصل 0 راى',
