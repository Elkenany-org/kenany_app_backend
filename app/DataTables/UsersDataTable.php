    ...
    */
    ...
    {   
        ...
        return datatables()
                ...
                ->rawColumns(['name','email','phone','created_at']);
    }
    ...
    private function getDataArrayArabic(){
        if(app()->getLocale()  == 'ar'){
            return    [
                    ...
                    'sLengthMenu'   => 'اعرض _MENU_ المستخدمين',
                    'sZeroRecords'  => 'لم يعثر على أية المستخدمين',
                    'sInfo'         => 'عرض _START_ إلى _END_ من أصل _TOTAL_ المستخدمين',
                    'sInfoEmpty'    => 'يعرض 0 إلى 0 من أصل 0 المستخدم',
