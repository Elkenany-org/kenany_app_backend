...
@section('content')
<div class="row g-5 g-xl-8 px-3 pt-5 statcics">
    <div class="col-xl-3">
        <!--begin::Statistics Widget 5-->
        <a href="" class="card card-xl-stretch mb-xl-8" style="background: #de324c !important">
            <!--begin::Body-->
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <div class="text-inverse-body fw-bolder fs-2 mb-2 mt-5">{{ $companies }}</div>
                <div class="fw-bold text-inverse-body fs-7">
                     {{ TranslationHelper::translate('guide' , 'admin') }}  </div>
            </div>
            <!--end::Body-->
        </a>
    ...
    <div class="col-xl-3">
        <!--begin::Statistics Widget 5-->
        <a href="" class="card  card-xl-stretch mb-xl-8" style="background: #e95e56 !important">
            <!--begin::Body-->
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <div class="text-inverse-dark fw-bolder fs-2 mb-2 mt-5">{{ $ships }}</div>
                <div class="fw-bold text-inverse-dark fs-7">
                    {{ TranslationHelper::translate('ship_movement' , 'admin') }} </div>
            </div>
            <!--end::Body-->
        </a>
        <!--end::Statistics Widget 5-->
    ...
    <div class="col-xl-3">
        <!--begin::Statistics Widget 5-->
        <a href="" class="card  card-xl-stretch mb-xl-8" style="background: #f4895f !important">
            <!--begin::Body-->
            <div class="card-body">
                ...
                <div class="fw-bold text-inverse-warning fs-7">
                    {{ TranslationHelper::translate('products_ships' , 'admin') }} </div>
            </div>
            <!--end::Body-->
        </a>
        <!--end::Statistics Widget 5-->
    ...
    <div class="col-xl-3">
        <!--begin::Statistics Widget 5-->
        <a href="" class="card card-xl-stretch mb-5 mb-xl-8"  style="background: #f8e16f !important">
            <!--begin::Body-->
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <div class="text-inverse-info fw-bolder fs-2 mb-2 mt-5">{{ $admins }}</div>
                <div class="fw-bold text-inverse-info fs-7">
                    {{ TranslationHelper::translate('admins' , 'admin') }} </div>
            </div>
            <!--end::Body-->
        </a>
        <!--end::Statistics Widget 5-->
