...
@section('crumb')
    <x-bread-crumb :breadcrumbs="[
        ['text'=> TranslationHelper::translate('category' , 'admin') ,'link'=>route('admin.category.index')],
        ['text'=> TranslationHelper::translate( Str::replace(' ' , '_', Str::lower(getLastKeyRoute(request()->route()->getName()))) , 'admin')]
        ]" :button="['text'=> TranslationHelper::translate('go_to_categories' , 'admin') ,'link'=>route('admin.category.index')]"
        :permission="auth('admin')->user()->can('categories.read')">
    </x-bread-crumb>
@endsection
                            ...
                            <div class="fv-row mb-10">
                                <div class="row justify-content-center align-items-center mt-3">
                                    <div class="col-3 my-3">
                                        ...
                                        <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true" style="background: url('{{ $category->getAvatar() }}');background-size:100% 100%">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-{{ count(Config('language')) > 1  ? 6 : 12 ;}}">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-solid" required value="{{ old('title.'.$key) ?? $category->getTranslation('title',$key)}}" placeholder="{{ $lang }}" name="title[{{ $key}}]" />
                                        @error('title.'.$key)
