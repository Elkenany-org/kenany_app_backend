...
@section('crumb')
    <x-bread-crumb :breadcrumbs="[
            ['text'=>  TranslationHelper::translate('countries' , 'admin') ,'link'=>route('admin.country.index')],
            ['text'=>  TranslationHelper::translate('list' , 'admin')]
            ]" :button="['text'=> TranslationHelper::translate('add_country' , 'admin'),'link'=>route('admin.country.create')]"
            :permission="auth('admin')->user()->can('countries.create')">
    </x-bread-crumb>
@endsection
