...
@section('crumb')
    <x-bread-crumb :breadcrumbs="[
        ['text'=> TranslationHelper::translate('faqs' , 'admin') , 'link'=>route('admin.faq.index')],
        ['text'=> TranslationHelper::translate('list' , 'admin')]
        ]" :button="['text'=> TranslationHelper::translate('add_faq', 'admin') ,'link'=>route('admin.faq.create')]"
        :permission="auth('admin')->user()->can('faqs.create')">
    </x-bread-crumb>
@endsection
                    ...
                    <form action="#" id="datatable_form_filter" method="GET" class="mt-3">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-sm-12">
                                <label for=""> {{ TranslationHelper::translate('search_question' , 'admin') }}  </label>
                                <input type="text" id="title" name="title" class="form-control" placeholder="{{ TranslationHelper::translate('search_question' , 'admin') }}">
                            </div>
                            <div class="col-lg-6 col-sm-12">
