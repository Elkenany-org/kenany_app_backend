...
<x-bread-crumb :breadcrumbs="[
        ...
        ]" :button="['text'=> TranslationHelper::translate('send_notification', 'admin') ,'link'=>route('admin.notification.create')]" :permission="auth('admin')->user()->can('notifications.create')">
</x-bread-crumb>
@endsection
                    ...
                    <form action="#" id="datatable_form_filter" method="GET" class="mt-3">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-sm-12">
                                ...
                                <input type="text" id="title" name="title" class="form-control" placeholder="{{ TranslationHelper::translate('search_title' , 'admin') }}">
                            </div>
                            <div class="col-lg-6 col-sm-12">
