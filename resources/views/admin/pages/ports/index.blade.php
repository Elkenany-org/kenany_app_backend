...
@section('crumb')
    <x-bread-crumb :breadcrumbs="[
            ['text'=>  TranslationHelper::translate('ports' , 'admin') ,'link'=>route('admin.port.index')],
            ['text'=>  TranslationHelper::translate('list' , 'admin')]
            ]" :button="['text'=> TranslationHelper::translate('add_port' , 'admin'),'link'=>route('admin.port.create')]"
            :permission="auth('admin')->user()->can('ports.create')">
    </x-bread-crumb>
@endsection
