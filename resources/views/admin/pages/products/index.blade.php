...
@section('crumb')
    <x-bread-crumb :breadcrumbs="[
        ['text'=> TranslationHelper::translate( 'products' , 'admin'),'link'=>route('admin.product.index')],
        ['text'=> TranslationHelper::translate( 'list' , 'admin')]
        ]" :button="['text'=> TranslationHelper::translate( 'add_product' , 'admin'),'link'=>route('admin.product.create')]"
        :permission="auth('admin')->user()->can('products.create')">
    </x-bread-crumb>
@endsection
                ...
                <div class="p-3">
                    <form action="#" id="datatable_form_filter" method="GET" class="mt-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 col-sm-12">
                                <label for="">{{ TranslationHelper::translate( 'category' , 'admin') }} </label>
                                <select name="category" class="form-control" id="category">
                                    @foreach(app('genericCategories') as $category)     
                             ...
                             <div class="col-lg-4 col-sm-12">
                                ...
                                <input type="date" id="date" name="created_at"
                                    class="form-control" >
                            </div>
                        </div>
                    </form>
