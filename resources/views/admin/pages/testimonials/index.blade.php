...
@section('crumb')
    <x-bread-crumb :breadcrumbs="[
        ['text'=> TranslationHelper::translate('testimonials' , 'admin') ,'link'=>route('admin.testimonial.index')],
        ['text'=> TranslationHelper::translate('list' , 'admin')]
        ]" :button="['text'=> TranslationHelper::translate('add_testimonial' , 'admin'),'link'=>route('admin.testimonial.create')]"
        :permission="auth('admin')->user()->can('testimonials.create')">
    </x-bread-crumb>
@endsection
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-sm-12">
                                ...
                                <input type="text" id="title" name="title"
                                    class="form-control" placeholder="{{ TranslationHelper::translate('search_title' , 'admin') }}">
                            </div>
                             <div class="col-lg-6 col-sm-12">
